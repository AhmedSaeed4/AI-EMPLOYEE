...
async def post_content(
    ...
    try:
        ...
        if post_btn:
            # Use JavaScript click to bypass LinkedIn's bot detection
...
@mcp.tool()
async def validate_session() -> str:
    """
...
async def main_async():
    ...
    try:
        ...
        print_status("Tools available: post_content, reply_to_message, get_messages, validate_session", "🛠️")
        print_status("", "")
